  ...
  return <Modal transparent animationType="fade" visible={visible} onRequestClose={onClose}>
    <View accessibilityViewIsModal style={styles.overlay}>
      ...
      <View style={styles.sheet}>
        ...
        <TextInput accessibilityLabel={`${title} reps`} autoFocus keyboardType="number-pad" onChangeText={(text) => setDraft(text.replace(/[^0-9]/g, ''))} onSubmitEditing={save} returnKeyType="done" selectTextOnFocus style={styles.input} value={draft} />
