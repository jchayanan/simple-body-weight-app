...
if (tabIconName('profile', true) !== 'settings') throw new Error('Settings must use the filled icon when active.');
if (tabIconName('profile', false) !== 'settings-outline') throw new Error('Settings must use the filled icon when inactive.');
