...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  sessionLog: { borderTopWidth: 1, borderBottomWidth: 1, borderColor: colors.segmentOff, marginBottom: spacing.lg },
  ...
  savedName: { color: colors.instrumentMuted, fontFamily: fonts.body, fontSize: 12 },
  savedValue: { color: colors.success, fontFamily: fonts.body, fontSize: 12, fontWeight: '700' },
  exerciseHeader: { alignItems: 'center', marginBottom: spacing.md },
  exerciseTitle: { color: colors.white, fontFamily: fonts.body, fontSize: 32, fontWeight: '800', textAlign: 'center' },
  range: { color: colors.instrumentMuted, fontFamily: fonts.body, fontSize: 14, fontWeight: '700', marginTop: spacing.xs },
  repBlock: { backgroundColor: colors.segmentOff, borderWidth: 1, borderColor: colors.segmentOff, alignItems: 'center', paddingVertical: spacing.lg, marginBottom: spacing.md },
  repLabel: { color: colors.instrumentMuted, fontFamily: fonts.body, fontSize: 12, fontWeight: '800', letterSpacing: 0.8 },
  repValue: { color: colors.accent, fontFamily: fonts.display, fontSize: 78, lineHeight: 86, marginBottom: spacing.md },
