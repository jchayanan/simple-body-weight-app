...
const createStyles = (colors: AppColors) => StyleSheet.create({ header: { alignItems: 'center', backgroundColor: colors.background, borderBottomColor: colors.ink, borderBottomWidth: 2, marginHorizontal: -spacing.lg, paddingHorizontal: spacing.lg, paddingBottom: spacing.xxl + spacing.sm, paddingTop: spacing.xxl + spacing.sm }, check: { alignItems: 'center', backgroundColor: colors.success, height: 56, justifyContent: 'center', marginBottom: spacing.lg, width: 56 }, title: { color: colors.ink, fontFamily: fonts.display, fontSize: 44, fontWeight: '700', letterSpacing: -0.8, maxWidth: '100%', textAlign: 'center' }, subtitle: { color: colors.muted, fontFamily: fonts.body, fontSize: 15, lineHeight: 22, marginTop: spacing.sm, maxWidth: 312, textAlign: 'center' }, summary: { borderBottomWidth: 1, borderColor: colors.ink, borderTopWidth: 1, flexDirection: 'row', marginTop: spacing.xl }, stat: { alignItems: 'center', borderRightColor: colors.border, borderRightWidth: 1, flex: 1, paddingVertical: spacing.lg }, lastStat: { borderRightWidth: 0 }, value: { color: colors.accent, fontFamily: fonts.body, fontSize: 32, fontWeight: '800', letterSpacing: -0.6 }, label: { color: colors.muted, fontFamily: fonts.body, fontSize: 11, marginTop: spacing.xs, textAlign: 'center' }, record: { alignItems: 'flex-start', borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: 'row', paddingVertical: spacing.lg }, recordMark: { backgroundColor: colors.success, height: 18, marginRight: spacing.md, marginTop: 4, width: 4 }, recordCopy: { flex: 1 }, recordTitle: { color: colors.ink, fontFamily: fonts.body, fontSize: 14, fontWeight: '800' }, recordBody: { color: colors.muted, fontFamily: fonts.body, fontSize: 14, lineHeight: 21, marginTop: spacing.xs }, bottom: { marginTop: 'auto', paddingTop: spacing.xl }, secondaryAction: { alignItems: 'center', justifyContent: 'center', minHeight: 44, marginTop: spacing.xs }, secondaryLabel: { color: colors.accent, fontFamily: fonts.body, fontSize: 14, fontWeight: '800' }, footer: { color: colors.muted, fontFamily: fonts.body, fontSize: 12, marginTop: spacing.sm, textAlign: 'center' }, pressed: { opacity: 0.68 } });
