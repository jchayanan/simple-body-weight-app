...
const styles = StyleSheet.create({ header: { alignItems: 'center', paddingTop: spacing.xxl, paddingBottom: spacing.xxl }, check: { alignItems: 'center', backgroundColor: colors.success, borderRadius: 26, height: 52, justifyContent: 'center', marginBottom: spacing.lg, width: 52 }, title: { color: colors.ink, fontFamily: fonts.display, fontSize: 42 }, sessionName: { color: colors.accent, fontFamily: fonts.body, fontSize: 14, fontWeight: '700', marginTop: spacing.sm, textAlign: 'center' }, subtitle: { color: colors.muted, fontFamily: fonts.body, fontSize: 15, lineHeight: 22, marginTop: spacing.sm, maxWidth: 288, textAlign: 'center' }, summary: { borderBottomWidth: 1, borderColor: colors.border, borderTopWidth: 1, flexDirection: 'row' }, stat: { alignItems: 'center', borderRightColor: colors.border, borderRightWidth: 1, flex: 1, paddingVertical: spacing.lg }, lastStat: { borderRightWidth: 0 }, value: { color: colors.ink, fontFamily: fonts.display, fontSize: 32 }, label: { color: colors.muted, fontFamily: fonts.body, fontSize: 11, marginTop: spacing.xs }, record: { alignItems: 'flex-start', borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: 'row', paddingVertical: spacing.lg }, recordMark: { backgroundColor: colors.success, height: 8, marginRight: spacing.md, marginTop: 7, width: 8 }, recordCopy: { flex: 1 }, recordTitle: { color: colors.ink, fontFamily: fonts.body, fontSize: 14, fontWeight: '800' }, recordBody: { color: colors.muted, fontFamily: fonts.body, fontSize: 14, lineHeight: 21, marginTop: spacing.xs }, bottom: { marginTop: 'auto', paddingTop: spacing.xl }, footer: { color: colors.muted, fontFamily: fonts.body, fontSize: 12, marginTop: spacing.sm, textAlign: 'center' } });
